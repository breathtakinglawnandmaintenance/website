  ...
  return (
    <footer className="bg-primary-950 text-stone-300 py-20 border-t border-white/5">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr_1.3fr_0.9fr] gap-10 items-start text-center md:text-left">
          ...
          {/* 3. MIDDLE-RIGHT: Business Information */}
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex items-center gap-4 justify-center md:justify-start">
              ...
              <span className="text-xs font-light text-stone-500 uppercase tracking-widest text-center md:text-left">
                Follow our work
              </span>
            </div>
          </div>
